...
expr_900 -> expr_900 '.' atom :
        case erlson_pt:is_valid_dict_path('$1') of
            true ->
                %{record_field,?anno('$2'),'$1','','$3'};
                erlson_pt:make_dict_fetch(?anno('$2'), '$3', '$1');
            false ->
                ret_err(?anno('$2'), "bad dictionary syntax")
        end.
expr_900 -> expr_max : '$1'.
...
record_expr -> '#' dict_tuple :
	%{record,?anno('$1'),'','$2'}.
        erlson_pt:make_dict_new(?anno('$1'), '$2').
...
dict_field -> dict_field_path :
	{record_field,?anno(hd('$1')),'$1',{atom,?anno(hd('$1')),true}}.
dict_field -> dict_field_path '=' expr :
	{record_field,?anno(hd('$1')),'$1','$3'}.
